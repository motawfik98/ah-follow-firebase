<template>
    <div>
        ...
        <fieldset class="border p-2">
            ...
            <div class="form-row m-3" v-for="(user, index) in task.workingOnUsers" :key="user.uid">
                <div class="col-12 col-md-4">
                    {{user.username}}
                </div>
                <div class="col-12 col-md form-group">
                    <input type="text" :name="'action_' + index" class="form-control repeat_form"
                           v-if="userProfile.classification === 2 && !review"
                ...
                <div class="col-1 form-check pl-3">
                    ...
                    <input type="checkbox" class="form-check-input repeat_form" :value="user.isFinalResponse"
                           :disabled="user.response === undefined || user.response === '' || userProfile.classification !== 2 || currentStep !== 2"
